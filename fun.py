...
async def cmd_fuck(message: Message, bot: Bot):
    ...
    text = f'🔥 | <b>{sender_name}</b> жестко выебал(а) <b>{partner_name}</b>'
...
async def cmd_stata(message: Message, bot: Bot, user_stats: dict):
    ...
    text = (
        f'{_ce("5904630315946611415", "👤")} {user_display}\n\n'
        f'{_ce("6039404727542747508", "💬")} {msg_count}\n'
        f'{_ce("6039565797406282001", "🎭")} {sticker_count}\n'
        f'{_ce("5944777041709633960", "🎬")} {gif_count}\n'
        f'{_ce("6030506650522096180", "🎥")} {video_note_count}\n'
        f'{_ce("6030722571412967168", "🎤")} {voice_count}\n\n'
        f'{_ce("6037421444789440735", "📅")} {days_str}'
    )
